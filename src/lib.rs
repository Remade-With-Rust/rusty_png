...
//! let decoder = rusty_png::Decoder::new(File::open("tests/pngsuite/basi0g01.png").unwrap());
...
//!
//! let mut encoder = rusty_png::Encoder::new(w, 2, 1); // Width is 2 pixels and height is 1.
//! encoder.set_color(rusty_png::ColorType::Rgba);
//! encoder.set_depth(rusty_png::BitDepth::Eight);
//! encoder.set_source_gamma(rusty_png::ScaledFloat::from_scaled(45455)); // 1.0 / 2.2, scaled by 100000
//! encoder.set_source_gamma(rusty_png::ScaledFloat::new(1.0 / 2.2));     // 1.0 / 2.2, unscaled, but rounded
//! let source_chromaticities = rusty_png::SourceChromaticities::new(     // Using unscaled instantiation here
//!     (0.31270, 0.32900),
//!     (0.64000, 0.33000),
//!     (0.30000, 0.60000),
//!     (0.15000, 0.06000)
